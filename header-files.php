...
<td class="fix-td" valign="top" align="left" colspan="2"><img alt="" src="http://palmbeachletter.com/wp-content/themes/responsive-child/pub-images/<?php
echo types_render_field("banner", array("output"=>"raw"));
?> "></td>
