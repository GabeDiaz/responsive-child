                                    ...
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                            <font size="3" face="Georgia, Arial, Helvetica, sans-serif">
                                                <table id="content_block" style="margin-top: -20px; font-size: 100%;" width="900" border="0" align="center" cellpadding="0" cellspacing="10">
                                                    <tbody>
                                                    <tr>
                                                        <td>
                                                            <center>
                                                                ...
                                                                <?php if(get_the_author_meta('ID') != 1) : ?>
                                                                    <font size="3" face="Georgia, Arial, Helvetica, sans-serif">
                                                                     ...
                                                                     <span id="essayEditor">
                                                                       <?php echo types_render_field('byline', array("output"=>"text")) . ' ' . get_the_author();?>
                                                                     </span>
                                                            ...
                                                            <br>
                                                            <font size="3" face="Georgia, Arial, Helvetica, sans-serif">
                                                                <?php echo types_render_field('content', array("output"=>"html"));?>
                                                            </font>
                                                        </td>
                                                    </tr>
                                                    </tbody>
