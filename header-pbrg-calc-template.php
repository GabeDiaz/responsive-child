...
@import http://palmbeachgroup.com/wp-content/themes/responsive/style.css?ver=1.9.3.4;

#header {
    /* background-image: url('http://media.palmbeachgroup.com/images/pbrg/pbl_bg_header_wide.png'); */
    padding: 0;
...
<div style=" display:none; width: 100%;  background-color: #fcf9f3;  border-bottom: 1px solid #C8C8C8;  padding: 20px 0 10px;opacity: .9;position: fixed;  -webkit-box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.2);
  -moz-box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.2);
  box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.2);">
<div style="  margin: auto;  width: 860px;"><a href="http://palmbeachgroup.com"><img src="http://media.palmbeachgroup.com/images/pbrg/pbrg-cropped-logo-01.png" width="350" title="Palm Beach Research Group"></a></div>
</div>
...
<header>
<div id="header">
<div id="header-wrapper" style="max-width: 1300px;margin: auto;margin-top: 20px; /* padding: 30px 0 0 0; */overflow: auto;">
<div id="logo" class="grid col-220" style="margin: 0;/* height: 100%; */"> <a href="http://palmbeachgroup.com/"><img src="http://media.palmbeachgroup.com/images/pbrg/pbrg-cropped-logo-01.png" width="320" alt="Palm Beach Research Group" title="Palm Beach Research Group"></a> </div>
    <!-- end of #logo -->
    <div class="search-container" style="display:none;margin-right: 0;
    margin-top: 0;">
      <form method="get" action="http://palmbeachgroup.com/">
