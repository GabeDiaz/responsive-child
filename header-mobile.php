...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/responsive.tables.css" type="text/css"/>
...
if (typeof(__exitsplash) != 'undefined') __exitsplash.setPreventExitSplash(true);
window.location.href = 'http://dev.palmbeachletter.com/mobile-transcript.php';
}
});
</script>
...
<div class="login-link action hide-980">
<a href="#">Log in</a>
</div>
