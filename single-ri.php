...
<div style="float:left; width:50%;color: #000000;  font-size: 10px;    margin-left: 13px;    margin-top: 12px;  margin-bottom: 10px;  height: 25px;font-family: Georgia, serif;font-size: 16px;"><?php the_time('F j, Y'); ?></div>
...
?>
 ...
 <center>
  <table width="580px" border="0" cellspacing="10" cellpadding="0"><tbody><tr><td><div align="center"><font face="Georgia, Arial, Helvetica, sans-serif" size="5"><b id="updateTitle"><?php the_title();?></b></font></div></td></tr></tbody></table>
