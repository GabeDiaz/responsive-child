<?php
/*
Template Name: Mega Trends Investing Portfolio
*/
...
<div style="font-family: Georgia, Times New Roman, Helvetica, sans-serif; font-size: 30px; font-style: normal; color: #444; border-bottom: 1px solid #ccc; padding: 6px 0 12px 0px;margin-top:10px;">Mega Trends Investing - Portfolio</div>
