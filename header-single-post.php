                                                    ...
                                                    <tbody><tr>
                                                        <td valign="top" bgcolor="#DCEDE4" align="left"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody><tr>
                                                                ...
                                                                <td class="fix-td" valign="top" align="left" colspan="2"><img alt="" src="<?=$img?>"></td>
                                                            </tr>
                                                            <tr>
                         <td width="415" valign="top" align="right">

<?php if( has_term( 'clb', 'pubcode' ) ) { ?>
<div style="display:none;"><font size="3" face="Georgia, Arial, Helvetica, sans-serif"><?php the_date('F j, Y')?></font></div>
<?php }
else{ ?>
<font size="3" face="Georgia, Arial, Helvetica, sans-serif"><?php the_date('F j, Y')?></font>
<?php }?>




</td>                                                                <td width="13" valign="top" align="right"><img width="1" height="38" src="/images/1x1GRNpixel.gif"></td>
                                                            </tr>
                                                            </tbody></table></td>
                                                    </tr>
                                                    </tbody>
