...
if ($pubcodedesc == 'dbk'){
  $pubcodedesc = "Palm Beach Infinity - DealBook"; 
}
...
?>
  ...
  <span style="background-color: #258815; padding: 6px 10px; border-radius: 2px; color: #fff; font-weight: bold; border-radius: 2px;">Open</span>
  </div>
