...
if ($pubcodedesc == 'mtw'){
  $pubcodedesc = "Mega Trends Wealth Summit"; 
}
?>
...
<div class="m-cols ">
  <div id="content" class="grid-right col-620 fit">
    <div class="category-description-name"><?php $category = get_the_category(); echo $category[0]->cat_name; ?></div>
