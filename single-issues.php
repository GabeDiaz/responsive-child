  ...
  <tbody>
    <tr>
      <td valign="top" height="150" bgcolor="#DCEDE4" align="left"><table width="100%" cellspacing="0" cellpadding="1" border="0">
          <tbody>
            <tr>
              <td valign="top" bgcolor="#CCCCCC" align="left"><div class="content_block">
                  <div class="txt_controls"> <span>Text size</span> <a class="plus" style="text-decoration: none; outline:none;" href=""> <img style="border:none;" src="<?php bloginfo('template_directory');?>/core/images/tc_plus.gif" width="12" height="12" alt="" title=""> </a> <a class="minus" style="text-decoration: none; outline:none;" href=""> <img style="border:none;" src="<?php bloginfo('template_directory');?>/core/images/tc_minus.gif" width="12" height="12" alt="" title=""> </a> <span>Print</span> <img onclick="window.print();" src="<?php bloginfo('template_directory');?>/core/images/tc_print.gif" width="12" height="12" alt="" title=""> </div>
                  <table width="100%" cellspacing="0" cellpadding="20" border="0">
                    <tbody>
                      <tr>
                        <td bgcolor="#FFFFFF"><font size="3" face="Georgia, Arial, Helvetica, sans-serif">
...
?>
                                  <center>
                                    <table width="100%" border="0" cellspacing="10" cellpadding="0">
                                      <tbody>
                                        <tr>
                                          <td><div align="center"> <font face="Georgia, Arial, Helvetica, sans-serif" size="5"><b id="updateTitle">
                                              <?php the_title();?>
                                              </b></font> </div></td>
                                        </tr>
                                      </tbody>
                                    ...
                                    <?php
                                                                ...
                                                                if(!empty($subhead)) : ?>
                                    <font size="4" face="Georgia, Arial, Helvetica, sans-serif"> <span id="SubHeadline"> <i><?php echo $subhead;?></i> </span> <br>
                                    </font>
                                    <?php endif;?>
...
?>
                                  ...
                                  <font size="3" face="Georgia, Arial, Helvetica, sans-serif"> <?php echo types_render_field('body', array("output"=>"html"));?>
                                  <?php
if ( is_user_logged_in() ) {
