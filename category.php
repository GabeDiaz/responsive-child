...
if ($pubcodedesc == 'cwe'){
  $pubcodedesc = "Creating Wealth"; 
}
if ($pubcodedesc == 'pri'){
  $pubcodedesc = "Retirement Insider"; 
}
if ($pubcodedesc == 'pip'){
  $pubcodedesc = "Perpetual Income Program"; 
}
?>
...
<div class="m-cols ">
  <div id="content" class="grid-right col-620 fit">
    <div style="border-bottom:1px solid #eee;color: #649079;font: bold 28px/1.1em Arial, Helvetica, sans-serif;margin: 0 0 10px 0;padding: 10px 0 10px 0px;"><?php echo $current_category[0]->name; ?>
    </div>
    
    <?php query_posts( array(
  'post_type' => array( 'post', 'content'),
  'category_name' => $curcat[0]->slug,
// 'taxonomy' => 'pubcode',
// 'term' => $pbrgPubCode,
  'tax_query' => array(
		'relation' => 'OR',
		array(
			'taxonomy' => 'pubcode',
			'field'    => 'slug',
			'terms'    => array('$pbrgPubCode'),
		),
		array(
			'taxonomy' => 'content',
			'field'    => 'slug',
			'terms'    => array( 'publication'),
		),
	),
